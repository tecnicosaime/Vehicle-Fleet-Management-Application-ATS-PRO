...
const TasitKarti = () => {
  ...
  const fetchData = async (diff, targetPage) => {
    ...
    try {
      ...
      const response = await AxiosInstance.get(`VehicleCardReminder/GetVehicleCardReminderList?diff=${diff}&setPointId=${currentSetPointId}&parameter=${searchTerm}`);
  ...
  const [columns, setColumns] = useState(() => {
    const savedOrder = localStorage.getItem("columnOrderTasitKarti");
    const savedVisibility = localStorage.getItem("columnVisibilityTasitKarti");
    const savedWidths = localStorage.getItem("columnWidthsTasitKarti");
    ...
    localStorage.setItem("columnOrderTasitKarti", JSON.stringify(order));
    localStorage.setItem("columnVisibilityTasitKarti", JSON.stringify(visibility));
    localStorage.setItem("columnWidthsTasitKarti", JSON.stringify(widths));
  ...
  useEffect(() => {
    localStorage.setItem("columnOrderTasitKarti", JSON.stringify(columns.map((col) => col.key)));
    localStorage.setItem(
      "columnVisibilityTasitKarti",
      JSON.stringify(
        columns.reduce(
          (acc, col) => ({
            ...acc,
  ...
  // Reset columns
  const resetColumns = () => {
    localStorage.removeItem("columnOrderTasitKarti");
    localStorage.removeItem("columnVisibilityTasitKarti");
    localStorage.removeItem("columnWidthsTasitKarti");
