...
const CezaOdeme = () => {
  ...
  const fetchData = async (diff, targetPage) => {
    ...
    try {
      ...
      const response = await AxiosInstance.get(`FinePaymentReminder/GetFinePaymentReminderList?diff=${diff}&setPointId=${currentSetPointId}&parameter=${searchTerm}`);
  ...
  const [columns, setColumns] = useState(() => {
    const savedOrder = localStorage.getItem("columnOrderCezaOdeme");
    const savedVisibility = localStorage.getItem("columnVisibilityCezaOdeme");
    const savedWidths = localStorage.getItem("columnWidthsCezaOdeme");
    ...
    localStorage.setItem("columnOrderCezaOdeme", JSON.stringify(order));
    localStorage.setItem("columnVisibilityCezaOdeme", JSON.stringify(visibility));
    localStorage.setItem("columnWidthsCezaOdeme", JSON.stringify(widths));
  ...
  useEffect(() => {
    localStorage.setItem("columnOrderCezaOdeme", JSON.stringify(columns.map((col) => col.key)));
    localStorage.setItem(
      "columnVisibilityCezaOdeme",
      JSON.stringify(
        columns.reduce(
          (acc, col) => ({
            ...acc,
  ...
  // Reset columns
  const resetColumns = () => {
    localStorage.removeItem("columnOrderCezaOdeme");
    localStorage.removeItem("columnVisibilityCezaOdeme");
    localStorage.removeItem("columnWidthsCezaOdeme");
