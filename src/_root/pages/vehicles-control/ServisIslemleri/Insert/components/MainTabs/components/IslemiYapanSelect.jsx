...
export default function IslemiYapanSelect({ disabled, fieldRequirements }) {
  const {
    control,
    setValue,
    watch,
          ...
          render={({ field }) => (
            <Select
              ...
              onChange={(value) => {
                ...
                setValue("islemiYapanSelect", value ?? null);
                setValue("islemiYapanSelectID", value ?? null);
