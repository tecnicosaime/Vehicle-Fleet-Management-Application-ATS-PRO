...
export default function AktifYap({ selectedRows, refreshTableData, disabled, hidePopover }) {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      const response = await AxiosInstance.post(`Activate/ActivateVehicleById`, body);
