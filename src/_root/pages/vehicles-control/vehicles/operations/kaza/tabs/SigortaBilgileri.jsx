...
const SigortaBilgileri = () => {
  ...
  return (
    <>
      <h2>
        <CheckboxInput name="sigortaBilgisiVar" /> {t("sigortaBilgileri")}
      </h2>
        ...
        <div className="col-span-3">
          <div className="grid gap-1">
            ...
            <div className="col-span-2 self-end">
              <Button onClick={handleOpen} disabled={!watch("sigortaBilgisiVar")}>
                ...
              </Button>
            </div>
          </div>
      ...
      <Modal title={t("sigortalar")} open={open} onCancel={() => setOpen(false)} maskClosable={false} footer={footer} width={1200} key={modalKey}>
