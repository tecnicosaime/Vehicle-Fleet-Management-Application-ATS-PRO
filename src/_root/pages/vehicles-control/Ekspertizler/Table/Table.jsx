...
const Sigorta = () => {
  ...
  const initialColumns = [
    ...
    {
      title: t("toplamEkspertizSayisi"),
      dataIndex: "toplamEkspertizSayisi",
      key: "toplamEkspertizSayisi",
      width: 120,
      ellipsis: true,
      visible: true, // Varsayılan olarak açık

      sorter: (a, b) => {
        if (a.toplamEkspertizSayisi === null) return -1;
        if (b.toplamEkspertizSayisi === null) return 1;
        return a.toplamEkspertizSayisi - b.toplamEkspertizSayisi;
      },
    },
