...
const Yakit = () => {
  ...
  const fetchData = async (diff, targetPage) => {
    ...
    try {
      ...
      const response = await AxiosInstance.post(`CostAnalysis/GetCostAnalysisInfoByType?diff=${diff}&setPointId=${currentSetPointId}&parameter=${searchTerm}&type=9`, body);
  ...
  const initialColumns = [
    ...
    {
      title: t("satinAlmaMaliyeti"),
      dataIndex: "satinAlmaMaliyeti",
    ...
    {
      title: t("sigortaMaliyeti"),
      dataIndex: "sigortaMaliyeti",
      key: "sigortaMaliyeti",
      width: 120,
      ellipsis: true,
      visible: true, // Varsayılan olarak açık   
    ...
    {
      title: t("bakimOnarimMaliyeti"),
      dataIndex: "bakimOnarimMaliyeti",
    ...
    {
      title: t("harcamaMaliyeti"),
      dataIndex: "harcamaMaliyeti",
      key: "harcamaMaliyeti",
      width: 120,
      ellipsis: true,
      visible: true, // Varsayılan olarak açık   
    ...
    {
      title: t("lastikMaliyeti"),
      dataIndex: "lastikMaliyeti",
      key: "lastikMaliyeti",
      width: 120,
      ellipsis: true,
      visible: true, // Varsayılan olarak açık   
  ...
  const [columns, setColumns] = useState(() => {
    const savedOrder = localStorage.getItem("columnOrderMaliletTip9");
    const savedVisibility = localStorage.getItem("columnVisibilityMaliyetTip9");
    const savedWidths = localStorage.getItem("columnWidthsMaliyetTip9");
    ...
    localStorage.setItem("columnOrderMaliletTip9", JSON.stringify(order));
    localStorage.setItem("columnVisibilityMaliyetTip9", JSON.stringify(visibility));
    localStorage.setItem("columnWidthsMaliyetTip9", JSON.stringify(widths));
  ...
  useEffect(() => {
    localStorage.setItem("columnOrderMaliyetTip9", JSON.stringify(columns.map((col) => col.key)));
    localStorage.setItem(
      "columnVisibilityMaliyetTip9",
      JSON.stringify(
        columns.reduce(
          (acc, col) => ({
            ...acc,
  ...
  // Reset columns
  const resetColumns = () => {
    localStorage.removeItem("columnOrderMaliyetTip9");
    localStorage.removeItem("columnVisibilityMaliyetTip9");
    localStorage.removeItem("columnWidthsMaliyetTip9");
    window.location.reload();
  };

  const componentTitle = t("toplamSahipOlmaMaliyeti");
