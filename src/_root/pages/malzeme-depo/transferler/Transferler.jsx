...
const breadcrumb = [{ href: "/", title: <HomeOutlined /> }, { title: t("transferler") }];
...
const Transferler = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const res = await GetMaterialTransferReceiptListService(search, tableParams.pagination.current, filterData);
      setLoading(false);
