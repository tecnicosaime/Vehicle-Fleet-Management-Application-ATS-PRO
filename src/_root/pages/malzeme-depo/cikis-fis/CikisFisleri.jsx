...
const breadcrumb = [{ href: "/", title: <HomeOutlined /> }, { title: t("cikisFisleri") }];
...
const CikisFisleri = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const res = await GetMaterialReleaseReceiptListService(search, tableParams.pagination.current, filterData);
      setLoading(false);
