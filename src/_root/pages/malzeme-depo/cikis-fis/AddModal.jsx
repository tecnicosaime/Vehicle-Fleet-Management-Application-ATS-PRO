...
const AddModal = ({ setStatus }) => {
  ...
  useEffect(() => {
    if (isOpen && isFirstRender.current) {
      GetModuleCodeByCode("STOK_FIS_SATIS").then((res) => setValue("fisNo", res.data));
    }
  }, [isOpen, setValue]);
  ...
  return (
    <>
      ...
      <Modal title={t("fisCikisBilgisiEkle")} open={isOpen} onCancel={() => setIsModalOpen(false)} maskClosable={false} footer={footer} width={1300} closeIcon={null}>
