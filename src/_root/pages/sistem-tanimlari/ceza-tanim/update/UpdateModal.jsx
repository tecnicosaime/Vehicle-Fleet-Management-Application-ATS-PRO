          ...
          <div className="grid gap-1">
            <div className="col-span-4">
              <div className="flex flex-col gap-1">
                ...
                <Controller name="madde" control={control} render={({ field }) => <Input {...field} onChange={(e) => field.onChange(e.target.value)} />} />
              </div>
            </div>
            <div className="col-span-4">
              <div className="flex flex-col gap-1">
                <label>{t("kime")}</label>
                <Controller name="kime" control={control} render={({ field }) => <Input {...field} onChange={(e) => field.onChange(e.target.value)} />} />
              </div>
            </div>
            <div className="col-span-4">
              <div className="flex flex-col gap-1">
                <label>{t("belgeNo")}</label>
                <Controller name="belgeNo" control={control} render={({ field }) => <Input {...field} onChange={(e) => field.onChange(e.target.value)} />} />
              </div>
            </div>
            <div className="col-span-4">
              <div className="flex flex-col gap-1">
                <label>{t("tutar")}</label>
                <Controller name="tutar" control={control} render={({ field }) => <InputNumber {...field} className="w-full" onChange={(e) => field.onChange(e)} />} />
              </div>
            </div>
            <div className="col-span-4">
              <div className="flex flex-col gap-1">
                <label>{t("puan")}</label>
                <Controller name="puan" control={control} render={({ field }) => <InputNumber {...field} className="w-full" onChange={(e) => field.onChange(e)} />} />
              </div>
            </div>
            <div className="col-span-12">
              <div className="flex flex-col gap-1">
                <label>{t("aciklama")} 1</label>
                <Controller name="aciklama1" control={control} render={({ field }) => <TextArea {...field} />} />
              </div>
            </div>
            <div className="col-span-12">
              <div className="flex flex-col gap-1">
                <label>{t("aciklama")} 2</label>
                <Controller name="aciklama2" control={control} render={({ field }) => <TextArea {...field} />} />
              </div>
            </div>
          </div>
        </form>
