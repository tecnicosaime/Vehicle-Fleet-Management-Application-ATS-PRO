...
const Yakit = () => {
  ...
  const fetchData = async (diff, targetPage) => {
    ...
    try {
      ...
      const response = await AxiosInstance.get(`PenaltyDef/GetPenaltyDefList?diff=${diff}&setPointId=${currentSetPointId}&parameter=${searchTerm}`);
  ...
  const initialColumns = [
    {
      ...
      sorter: (a, b) => {
        if (a.madde === null) return -1;
        if (b.madde === null) return 1;
        return a.madde.localeCompare(b.madde);
      },
    },

    {
      ...
      sorter: (a, b) => {
        if (a.kime === null) return -1;
        if (b.kime === null) return 1;
        return a.kime.localeCompare(b.kime);
      },
    },
    {
      title: t("aciklama1"),
      ...
      sorter: (a, b) => {
        if (a.aciklama1 === null) return -1;
        if (b.aciklama1 === null) return 1;
        return a.aciklama1.localeCompare(b.aciklama1);
      },
    },

    {
      ...
      sorter: (a, b) => {
        if (a.aciklama2 === null) return -1;
        if (b.aciklama2 === null) return 1;
        return a.aciklama2 - b.aciklama2;
      },
    },
...

    {
      ...
      sorter: (a, b) => {
        if (a.belgeNo === null) return -1;
        if (b.belgeNo === null) return 1;
        return a.belgeNo - b.belgeNo;
      },
    },
