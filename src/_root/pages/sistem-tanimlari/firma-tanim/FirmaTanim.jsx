...
const Yakit = () => {
  ...
  const initialColumns = [
    ...
    },
    {
      ...
      sorter: (a, b) => {
        if (a.firmaTipi === null) return -1;
        if (b.firmaTipi === null) return 1;
...

    {
      ...
      sorter: (a, b) => {
        if (a.tel_1 === null) return -1;
        if (b.tel_1 === null) return 1;
        return a.tel_1 - b.tel_1;
      },
    },

    {
      ...
      sorter: (a, b) => {
        if (a.tel_2 === null) return -1;
        if (b.tel_2 === null) return 1;
        return a.tel_2 - b.tel_2;
      },
    },

    {
      ...
      sorter: (a, b) => {
        ...
        if (b.borc === null) return 1;
        return a.borc - b.borc;
      },
    },
...

    {
      ...
      sorter: (a, b) => {
        ...
        if (b.adres_1 === null) return 1;
        return a.adres_1.localeCompare(b.adres_1);
      },
    },
...

    {
      ...
      sorter: (a, b) => {
        if (a.sektor === null) return -1;
        if (b.sektor === null) return 1;
        return a.sektor.localeCompare(b.sektor);
      },
    },
...

    {
      ...
      sorter: (a, b) => {
        ...
        if (b.ilgili_1 === null) return 1;
        return a.ilgili_1.localeCompare(b.ilgili_1);
      },
    },

    {
      ...
      sorter: (a, b) => {
        ...
        if (b.ilgili_2 === null) return 1;
        return a.ilgili_2.localeCompare(b.ilgili_2);
      },
    },
  ...
  const [columns, setColumns] = useState(() => {
    const savedOrder = localStorage.getItem("columnOrderFirmal");
    const savedVisibility = localStorage.getItem("columnVisibilityFirmal");
    const savedWidths = localStorage.getItem("columnWidthsFirmal");
    ...
    localStorage.setItem("columnOrderFirmal", JSON.stringify(order));
    localStorage.setItem("columnVisibilityFirmal", JSON.stringify(visibility));
    localStorage.setItem("columnWidthsFirmal", JSON.stringify(widths));
  ...
  useEffect(() => {
    localStorage.setItem("columnOrderFirmal", JSON.stringify(columns.map((col) => col.key)));
    localStorage.setItem(
      "columnVisibilityFirmal",
      JSON.stringify(
        columns.reduce(
          (acc, col) => ({
            ...acc,
  ...
  // Reset columns
  const resetColumns = () => {
    localStorage.removeItem("columnOrderFirmal");
    localStorage.removeItem("columnVisibilityFirmal");
    localStorage.removeItem("columnWidthsFirmal");
