...
const breadcrumb = [{ href: "/", title: <HomeOutlined /> }, { title: t("firmaTanimlari") }];
...
const FirmaTanim = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const res = await GetCompaniesListService(search, tableParams.pagination.current, filterData);
      setLoading(false);
