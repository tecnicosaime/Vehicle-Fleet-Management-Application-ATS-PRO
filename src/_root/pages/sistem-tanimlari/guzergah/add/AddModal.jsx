...
const AddModal = ({ setStatus, onRefresh }) => {
  ...
  return (
    <>
      ...
      <Modal title={t("yeniGuzergahGirisi")} open={openModal} onCancel={() => setopenModal(false)} maskClosable={false} footer={footer} width={600}>
            ...
            <div className="grid gap-1">
              ...
              <div className="col-span-6">
                <div className="flex flex-col gap-1">
                  ...
                  <Controller name="cikisSehriId" control={control} render={({ field }) => <Town field={field} />} />
                </div>
              </div>
              <div className="col-span-6">
                <div className="flex flex-col gap-1">
                  <label>{t("varisSehri")}</label>
                  <Controller name="varisSehriId" control={control} render={({ field }) => <TownVaris field={field} />} />
                </div>
              </div>
              <div className="col-span-6">
                <div className="grid gap-1">
                  <div className="col-span-10">
                    <div className="flex flex-col gap-1">
                      ...
                      <Controller name="cikisYeriId" control={control} render={({ field }) => <GuzergahCikisYeri field={field} />} />
                    </div>
                  </div>
                ...
                <div className="grid gap-1">
                  <div className="col-span-10">
                    <div className="flex flex-col gap-1">
                      ...
                      <Controller name="varisYeriId" control={control} render={({ field }) => <GuzergahVarisYeri field={field} />} />
                    </div>
                  </div>
                  <div className="col-span-2 self-end">
                    <Button onClick={() => setopenSehirYerModal(true)}>...</Button>
              ...
              <div className="col-span-3">
                <div className="flex flex-col gap-1">
                  <label>{t("saat")}</label>
                  <Controller name="saat" control={control} render={({ field }) => <InputNumber {...field} className="w-full" onChange={(e) => field.onChange(e)} />} />
                </div>
              </div>
              <div className="col-span-3">
                <div className="flex flex-col gap-1">
                  <label>{t("dakika")}</label>
                  <Controller name="dakika" control={control} render={({ field }) => <InputNumber {...field} className="w-full" onChange={(e) => field.onChange(e)} />} />
                </div>
              </div>
              <div className="col-span-3">
                <div className="flex flex-col gap-1">
                  <label>{t("mesafe")}</label>
                  <Controller name="mesafe" control={control} render={({ field }) => <InputNumber {...field} className="w-full" onChange={(e) => field.onChange(e)} />} />
                </div>
              </div>
              <div className="col-span-3">
                <div className="flex flex-col gap-1">
                  <label>{t("tuketim")}</label>
                  <Controller name="tuketim" control={control} render={({ field }) => <InputNumber {...field} className="w-full" onChange={(e) => field.onChange(e)} />} />
                </div>
              </div>
